...
namespace hal::x86_64
{
    class hal_factory final : public hal::interface::hal_factory
    {
        public:
            ...
            constexpr static uint64_t memory_manager_size = sizeof(hal::x86_64::memory_manager);
            alignas(hal::x86_64::memory_manager) static char memory_manager_buffer[];

            constexpr static uint64_t process_manager_size = sizeof(hal::x86_64::process_manager);
            alignas(hal::x86_64::process_manager) static char process_manager_buffer[];

            constexpr static uint64_t interrupt_size = sizeof(hal::x86_64::interrupt);
            alignas(hal::x86_64::interrupt) static char interrupt_buffer[];


            constexpr static uint64_t arch_initializer_size = sizeof(hal::x86_64::arch_initializer);
            alignas(hal::x86_64::arch_initializer) static char arch_initializer_buffer[];
