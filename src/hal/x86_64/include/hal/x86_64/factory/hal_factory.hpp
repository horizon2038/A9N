...
namespace a9n::hal::x86_64
{
    class hal_factory final : public a9n::hal::hal_factory
    {
      public:
        ...
        static constexpr uint64_t timer_size = sizeof(a9n::hal::x86_64::pit_timer);
