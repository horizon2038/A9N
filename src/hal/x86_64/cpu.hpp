...
namespace hal::x86_64
{
    ...
    {
        kernel::virtual_address kernel_stack_pointer;
        kernel::virtual_address user_stack_pointer;
    ...
    namespace segment_selector
    {
        ...
        constexpr static uint16_t IDT_OFFSET = sizeof(global_descriptor_table) + GDT_OFFSET;
    }
