...
namespace hal::x86_64
{
    ...
    class interrupt final : public hal::interface::interrupt
    {
        public:
            ...
            void register_handler(common::word irq_number, hal::interface::interrupt_handler target_interrupt_handler) override;
        ...
        private:
            void init_handler();
            void load_idt();
            void register_idt_handler(common::word irq_number, hal::interface::interrupt_handler target_interrupt_handler);
