...
#include <kernel/capability/draft_ipc_port.hpp>
...
TEST(ipc_port_test, ipc_send_test)
{
    ...
    a9n::kernel::draft_ipc_port  ipc_port;
    ...
    sender_buffer_1.message_tag
        = static_cast<a9n::word>(a9n::kernel::draft_ipc_port_operation::SEND);
    sender_buffer_1.set_message<static_cast<a9n::word>(
        a9n::kernel::draft_ipc_port_send_argument::MESSAGE_COUNT
    )>(1);
    sender_buffer_1.set_message<static_cast<a9n::word>(
        a9n::kernel::draft_ipc_port_send_argument::IS_BLOCK
    )>(1);
